...
module Tanker
  module UserToken
    ...
    def self.generate(b64_trustchain_id, b64_trustchain_private_key, user_id)
      ...
      hashed_user_id = self.hash_user_id(b64_trustchain_id, user_id)
      ...
      token = {
        ...
        user_secret: Base64.strict_encode64(self.create_user_secret(b64_trustchain_id, user_id))
      }

      Base64.strict_encode64(JSON.generate(token))
    end

    def self.hash_user_id(b64_trustchain_id, user_id)
      binary_trustchain_id = Base64.decode64(b64_trustchain_id)
    ...
    def self.create_user_secret(b64_trustchain_id, user_id)
